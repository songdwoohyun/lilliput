      ...
      <div className="space-y-5">
        {items.map((item, i) => (
          <div key={i} className="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-6">
            <span className="text-base text-[#4a5943] font-semibold italic sm:w-20 sm:shrink-0">{item.date}</span>
            <span className="text-base text-[#3a3226] leading-relaxed">{item.title}</span>
          </div>
        ))}
      </div>
    </div>
