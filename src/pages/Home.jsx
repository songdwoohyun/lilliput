...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f0e4d3]">
      <Helmet>
        <title>더 릴리풋 컬렉션 | 수원 돌하우스 갤러리</title>
        <meta
          name="description"
          content="경기 수원시 팔달구에 위치한 돌하우스 미니어처 갤러리, 더 릴리풋 컬렉션입니다. 1층 오픈 갤러리에서는 작품 상설 전시와 에코백·윙체어 등 오리지널 굿즈를, 2층 프라이빗 전시실에서는 예약제로 진행되는 특별한 미니어처 작품을 만나보실 수 있습니다."
        />
      </Helmet>
