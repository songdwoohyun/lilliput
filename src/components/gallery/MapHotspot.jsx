...
const houseImages = {
  ...
  'journey-between-books-0': new URL('../../assets/illustrations/houses/journey-between-books-0.png', import.meta.url).href,
  'journey-between-books-1': new URL('../../assets/illustrations/houses/journey-between-books-1.png', import.meta.url).href,
  'journey-between-books-2': new URL('../../assets/illustrations/houses/journey-between-books-2.png', import.meta.url).href,
  'journey-between-books-3': new URL('../../assets/illustrations/houses/journey-between-books-3.png', import.meta.url).href,
